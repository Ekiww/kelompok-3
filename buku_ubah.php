            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8"><input type="number" value="<?php echo $data['judul']; ?>"
                                class="form-control" name="tahun_terbit" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2">Deskripsi</div>
                        <div class="col-md-8">
                            <textarea name="deskripsi" rows="5" class="form-control"><?php echo $data['deskripsi']; ?>
                                </textarea>
                        </div>
                    </div>
                    <div class="row">
